...
const CarDetailContent: React.FC<CarDetailContentProps> = ({ carId, onBack, onEditSuccess }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col lg:flex-row bg-white">
      ...
      {/* Details Section */}
      <div className="w-full lg:w-1/2 flex flex-col min-h-0 lg:h-full">
        {/* Header */}
        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
          <Tabs value={tab} onValueChange={setTab} className="w-full h-full flex flex-col">
            ...
            <div className="flex-1 min-h-0 overflow-y-auto">
              <TabsContent 
                value="overview" 
                className="p-3 sm:p-6 flex flex-col data-[state=inactive]:hidden h-full"
              >
              ...
              <TabsContent 
                value="description" 
                className="p-3 sm:p-6 data-[state=inactive]:hidden h-full overflow-y-auto"
              >
