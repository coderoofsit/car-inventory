export const vehicleInspectionSchema = {
  ...
  engine: {
    ...
    leakages_oil_coolant: ["No Oil Leak, No Coolant Leak", "Oil Leak, No Coolant Leak", "No Oil Leak, Coolant Leak", "Oil Leak, Coolant Leak"],
    level_oil_coolant: ["Above Minimum", "At Minimum", "Below Minimum", "Empty"],
    contamination_oil_coolant: ["No Oil Contamination, No Coolant Contamination", "Oil Contamination, No Coolant Contamination", "No Oil Contamination, Coolant Contamination", "Oil Contamination, Coolant Contamination"],
    misfiring: ["yes", "no"],
  ...
  brakes: {
    ...
    oil_level_leakage: ["Minimum Level, No Leakage", "Full Level, No Leakage", "Minimum Level, Has Leakage", "Full Level, Has Leakage", "Empty Level, No Leakage", "Empty Level, Has Leakage"],
  ...
  electrical_system: {
    ...
    lamps_head_fog_tail: ["All Lamps Clear", "Head Lamp Dim, Others Clear", "Fog Lamp Dim, Others Clear", "Tail Lamp Dim, Others Clear", "Head Lamp Broken, Others Clear"],
